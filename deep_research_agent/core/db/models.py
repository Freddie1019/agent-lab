...
class AgentRunORM(Base):
    ...
    runtime_id: Mapped[str | None] = mapped_column(String(160), index=True, nullable=True)
    last_heartbeat_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), index=True, nullable=True)
